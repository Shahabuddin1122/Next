...
const footer = () => {
  return (
    <>
      <div className=" w-11/12 h-[800px] mx-auto my-2">
        ...
        <div className=" w-full h-2/5 mx-auto bg-yellow-200 flex">
          ...
          <div className=" w-1/3 h-full mx-5">
            <h1 className=" text-3xl font-semibold my-5">
              About Topical Fruits
            </h1>
            <p className=" text-cyan-500 text-xl my-2">Our Story 🎁</p>
            <p className=" text-cyan-500 text-xl my-2">
              💌 Tropical Fruit Box Reviews
            </p>
          ...
          <div className=" w-1/3 h-full mx-5">
            ...
            <p className=" text-xl my-2 text-gray-500 ">❤️ Tropi Rewards</p>
            <p className=" text-xl my-2 text-gray-500 ">
